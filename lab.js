...
//CODE HERE
if (amysAge > brittanisAge){   console.log("Amy is older") } else if (amysAge < brittanisAge){   console.log("Brittani is older") } else {   console.log("Amy and Brittani are the same age") }
...
console.log("Wear a trenchcoat and take umbrella")
} 
